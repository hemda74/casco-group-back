...
export const InsidersViewForm: React.FC<InsidersViewFormProps> = ({
  ...
  const description = initialData ? 'Edit a testimonial.' : 'Add a new testimonial';
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Make sure you removed all categories using this testimonial first.');
    } finally {
      setLoading(false);
      setOpen(false);
    }
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Testimonial Author Image</FormLabel>
                <FormControl>
                  <ImageUpload
          ...
          <div className="md:grid md:grid-cols-2 gap-8">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Testimonial Author Name (English)</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Testimonial Author Name (Arabic)</FormLabel>
                  <FormControl>
                    <Textarea disabled={loading} placeholder="" {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Testimonial Author title (English)</FormLabel>
                  <FormControl>
                    <Textarea disabled={loading} placeholder="" {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Testimonial Author Title (Arabic)</FormLabel>
                  <FormControl>
                    <Textarea disabled={loading} placeholder="" {...field} />
                  </FormControl>
                  <FormMessage />
